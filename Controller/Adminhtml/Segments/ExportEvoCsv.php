 ...
 */
class exportEvoCsv extends \Licentia\Equity\Controller\Adminhtml\Segments
{
    ...
    public function execute()
    {
        ...
        $fileName = 'form_evo_entries_' . $name . '.csv';
        $content = $this->_view->getLayout()
                               ->createBlock(
                                   'Licentia\Equity\Block\Adminhtml\Segments\Evolutions\Grid'
                               )
                               ->getCsv();
