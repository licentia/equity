 ...
 */
class Index extends \Licentia\Equity\Controller\Adminhtml\ExtraCosts
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Extra Costs'));
        $resultPage->addBreadcrumb(__('Sales Automation'), __('Sales Automation'));
        $resultPage->addBreadcrumb(__('Extra Costs'), __('Extra Costs'));
