 ...
 */
class Delete extends \Licentia\Equity\Controller\Adminhtml\ExtraCosts
{
        ...
        if ($model->getId()) {
            try {
                ...
                $this->messageManager->addExceptionMessage(
                    $e,
                    __('Something went wrong while deleting the note.')
                );
            }

            return $resultRedirect->setPath('*/*/edit', ['id' => $model->getId()]);
        } else {
            $this->messageManager->addErrorMessage(__('We can\'t find an Note to delete.'));
        }
