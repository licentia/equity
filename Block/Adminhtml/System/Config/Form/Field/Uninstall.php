 ...
 */
class Uninstall extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element
        ...
        $url = $this->getUrl('panda/account/attributes');
        ...
        return '<br><br><button  onclick="if(!confirm(\'' . $message .
               ...
               __('Remove Attributes') . '</span></span></span></button>';
    }
}
