...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Licentia\Equity\Model\ResourceModel\Sales\ExtraCosts\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        \Licentia\Equity\Model\ResourceModel\Sales\ExtraCosts\CollectionFactory $collectionFactory,
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->setId('pandaExtraCostsGrid');
        $this->setDefaultSort('cost_id');
    ...
    protected function _prepareCollection()
    {
        ...
        /* @var $collection \Licentia\Equity\Model\ResourceModel\Sales\ExtraCosts\Collection */
    ...
    public function optionResult($value, $row)
    {
        ...
        $note = $row->getData('note_type');

        if (stripos($note, 'segment_') !== false) {
            return 'N/A';
        }
