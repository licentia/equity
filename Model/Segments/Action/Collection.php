...
namespace Licentia\Equity\Model\Segments\Action;

/**
 * Class Collection
 *
 * @package Licentia\Equity\Model\Segments\Action
 */
class Collection extends \Magento\Rule\Model\Action\Collection
{
    ...
    public function __construct(
        ...
        $this->setType('Licentia\Equity\Model\Segments\Action\Collection');
    }
}
